export { ChangePasswordPage } from 'features/auth/components/changePassword/ChangePasswordPage'
export { CheckEmailPage } from 'features/auth/components/checkEmail/CheckEmailPage'
